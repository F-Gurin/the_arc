    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_nickname', models.CharField(max_length=50, unique=True, verbose_name='Telegram nickname')),
                ('phone', models.CharField(max_length=150, unique=True, verbose_name='Phone number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_type', models.CharField(choices=[('IND', 'Individual'), ('GRP', 'Group'), ('WEB', 'Webinar')], default='IND', max_length=3)),
                ('language', models.CharField(choices=[('ENG', 'English'), ('RUS', 'Russian'), ('UKR', 'Ukrainian')], default='RUS', max_length=3)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='session', to='Web_admin.patient', verbose_name='patient')),
        ...
        migrations.AddField(
            ...
            name='time_table_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='psychologist', to='Web_admin.sessions', verbose_name='time_table_id'),
        ),
    ]
